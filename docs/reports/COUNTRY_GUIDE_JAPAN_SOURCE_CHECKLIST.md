...
確認対象16件のうち、**15件が本文確認済み**です。
残り1件が終わるまで日本の `publicationStatus` は `'draft'` のままで、
...
この16件が確認対象です。残り1件の本文を読んで判断してください。
...
| カテゴリー | 概要（到着直後） |
| 本文確認状態 | **body-checked** |
| 本文を確認した資料 | 国土地理院「日本の主な山岳標高（1003山・令和8年3月31日）」 / 国土地理院「衛星測位を基盤とする三角点『富士山』の新しい標高」 |
| そのURL | https://www.gsi.go.jp/KOKUJYOHO/MOUNTAIN/1003zan20260331.pdf / https://www.gsi.go.jp/WNEW/PRESS-RELEASE/keikaku61003.html |
| 本文中で確認した内容 | 国土地理院「日本の主な山岳標高一覧（令和8年3月31日）」で、「富士山〈剣ヶ峯〉」の標高値が3,776mと記載されていることを確認した。同一覧の最大値が富士山の3,776mであり、次に高い北岳は3,193mなので、富士山が日本でいちばん高い山であることを確認した。あわせて国土地理院の報道発表で、二等三角点「富士山」の新しい標高成果は3775.56m（従来の標高成果は3775.51m）だが、富士山の最高地点は三角点より高い場所にあり、標高は3776mのまま変更されないと説明されていることを確認した。 |
| 採用／修正／削除 | 採用 |
| 確認日 | 2026-09-21 |
...
| カテゴリー | まち |
| 本文確認状態 | **body-checked** |
| 本文を確認した資料 | 日本政府観光局（JNTO）Travel Japan「Tokyo」 / 参議院法制局「首都を定める法律」 |
| そのURL | https://www.japan.travel/en/destinations/kanto/tokyo/ / https://houseikyoku.sangiin.go.jp/column/column081.htm |
| 本文中で確認した内容 | 日本政府観光局（JNTO）の東京紹介ページに「As Japan’s capital」と明記されていることを確認した。元の候補だった東京都「都の概要」は関連ページへの入口であり、首都という記述を確認できなかったため根拠には使わない。あわせて、参議院法制局のコラム「首都を定める法律」で、首都を定める法律は現在存在しないこと、一方で内閣法制局長官答弁（昭和54年6月5日 参議院内閣委員会）が東京を日本の首都として述べていること、東京には国の主要な行政機関・国会・最高裁判所があり辞書的な「首都」の要件を備えていること、法律上は「首都圏」の定義があること（首都圏整備法第2条第1項ほか）を確認した。法令の明文はないが、東京が首都であるという理解は公的にも示されており、「首都は東京です。」は資料の範囲内と判断した。なお本記事は法制局職員有志による解説記事で、無断転載が禁じられているため要約で記録する。東京都「東京都プロフィール」も確認したが、首都に関する記述は無かったため裏づけには使わない。 |
| 採用／修正／削除 | 採用 |
| 確認日 | 2026-09-21 |
...
| カテゴリー | まち |
| 本文確認状態 | **body-checked** |
| 本文を確認した資料 | 日本政府観光局（JNTO）Travel Japan「Tokyo」 |
| そのURL | https://www.japan.travel/en/destinations/kanto/tokyo/ |
| 本文中で確認した内容 | 日本政府観光局（JNTO）のページ見出しが「Tokyo」で、本文でも東京を日本の首都として紹介していることを確認した。 |
| 採用／修正／削除 | 採用 |
| 確認日 | 2026-09-21 |
...
| カテゴリー | しぜん |
| 本文確認状態 | **body-checked** |
| 本文を確認した資料 | 林野庁「都道府県別森林率・人工林率（令和4年3月31日現在）」 |
| そのURL | https://www.rinya.maff.go.jp/j/keikaku/genkyou/r4/1.html |
| 本文中で確認した内容 | 林野庁「都道府県別森林率・人工林率（令和4年3月31日現在）」の全国行で、森林面積25,024,810ha、国土面積37,297,154ha、森林率67%と記載されていることを確認した。67%はおよそ3分の2に当たる。全国の森林率は北方地域を除いて算出されているとの注記も確認した。 |
| 採用／修正／削除 | 採用 |
| 確認日 | 2026-09-21 |
...
| 本文中で確認した内容 | 観光庁公式ページから直接リンクされている公式MP4（04-30_En_1.mp4）を直接再生して確認した。降りる人を待って順番に乗ること、大きな荷物をほかの乗客のじゃまにならない場所へ置くこと、混雑した電車ではリュックを前に持つことが説明されていた。元の「大きな声で話さない」は動画内で確認できなかったため外し、確認できた荷物の話に直した。 |
| 採用／修正／削除 | 修正のうえ採用 |
| 確認日 | 2026-09-21 |
...
| 本文中で確認した内容 | 観光庁公式ページから直接リンクされている公式MP4（05-30_En_1.mp4）を直接再生して確認した。古い建物に触らないこと、祈っている参拝者のじゃまをしないことが説明されていた。元の「書かれている決まりを見てから入る」は確認できなかったため、動画で直接確認できた内容に直した。 |
| 採用／修正／削除 | 修正のうえ採用 |
| 確認日 | 2026-09-21 |
...
| 本文中で確認した内容 | 観光庁公式ページから直接リンクされている公式MP4（06-30_En_1.mp4）を直接再生して確認した。浴槽へ入る前に体を洗うよう説明されていた。元の「お風呂」は家庭の風呂まで含むように読めるため、資料が対象としている温泉・大浴場へ範囲を限定した。 |
| 採用／修正／削除 | 採用 |
| 確認日 | 2026-09-21 |
...
| `jnto-tokyo` | 日本政府観光局（JNTO）Travel Japan「Tokyo」 | https://www.japan.travel/en/destinations/kanto/tokyo/ | 済 | 2026-09-21 |
...
| `rinya-forest-r4` | 林野庁「都道府県別森林率・人工林率（令和4年3月31日現在）」 | https://www.rinya.maff.go.jp/j/keikaku/genkyou/r4/1.html | 済 | 2026-09-21 |
| `gsi-mountains` | 国土地理院「日本の主な山岳標高（1003山）」 | https://www.gsi.go.jp/kihonjohochousa/kihonjohochousa41139.html | 未 | — |
| `gsi-mountains-20260331` | 国土地理院「日本の主な山岳標高（1003山・令和8年3月31日）」 | https://www.gsi.go.jp/KOKUJYOHO/MOUNTAIN/1003zan20260331.pdf | 済 | 2026-09-21 |
| `gsi-fuji-elevation` | 国土地理院「衛星測位を基盤とする三角点『富士山』の新しい標高」 | https://www.gsi.go.jp/WNEW/PRESS-RELEASE/keikaku61003.html | 済 | 2026-09-21 |
...
| `kankocho-transport` | 観光庁「訪日外国人旅行者向けマナー啓発動画」PUBLIC TRANSPORTATION SCENE#04（公共交通機関編） | https://www.mlit.go.jp/kankocho/seisaku_seido/kihonkeikaku/jizoku_kankochi/jizokukano_taisei/torikumi/content/04-30_En_1.mp4 | 済 | 2026-09-21 |
| `kankocho-temples` | 観光庁「訪日外国人旅行者向けマナー啓発動画」TRADITIONAL BUILDINGS SCENE#05（神社仏閣・伝統的建築物編） | https://www.mlit.go.jp/kankocho/seisaku_seido/kihonkeikaku/jizoku_kankochi/jizokukano_taisei/torikumi/content/05-30_En_1.mp4 | 済 | 2026-09-21 |
| `kankocho-baths` | 観光庁「訪日外国人旅行者向けマナー啓発動画」PUBLIC BATHS AND HOTELS SCENE#06（温泉・宿泊施設編） | https://www.mlit.go.jp/kankocho/seisaku_seido/kihonkeikaku/jizoku_kankochi/jizokukano_taisei/torikumi/content/06-30_En_1.mp4 | 済 | 2026-09-21 |
...
日本政府観光局（JNTO）の japan.travel は、ホスト名を丸ごと固定して許可しています。
